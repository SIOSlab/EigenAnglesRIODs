from anglesOnlyRIOD import quadratic_eigenvalue_RIOD
import numpy as np 
...
determined_delta = quadratic_eigenvalue_RIOD(line_of_sight, STMs, STTs)

print("Quadratic eigenvalue algorithm results:", determined_delta)
